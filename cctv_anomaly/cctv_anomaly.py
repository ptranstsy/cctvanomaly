...
# Simulasi email pengguna (seharusnya diambil dari sesi login)
CURRENT_USER_EMAIL = "user@example.com"  # Ganti dengan logika autentikasi Anda
    ...
    message = {
        ...
        "sections": [{
            ...
            "facts": [
                ...
                {"name": "Reported by", "value": CURRENT_USER_EMAIL}
            ],
